...
describe('Hide this page', () => {
  ...
  it('renders the default example', () => {
    ...
    expect($button.attr('href')).toBe('https://www.google.com')
    expect($button.attr('data-new-tab-url')).toBe('https://www.bbc.co.uk/weather')
...
describe('Custom options', () => {
  it('renders with text', () => {
    ...
    expect($button.text()).toContain('Quick exit')
  })
